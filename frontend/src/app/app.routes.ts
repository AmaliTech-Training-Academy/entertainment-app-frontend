...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'user/dashboard',
        loadComponent: () => import('./pages/user-dashboard.page.component').then((m) => m.UserDashboardPageComponent),
        canActivate: [AuthGuard],
      },
      {
        path: 'search/advanced',
        loadComponent: () => import('./pages/advanced-search.page/advanced-search.page.component').then((m) => m.AdvancedSearchPageComponent),
        canActivate: [AuthGuard],
      },
      {
        path: 'recommendations/for-you',
        loadComponent: () => import('./pages/for-you.page.component').then((m) => m.ForYouComponent),
        canActivate: [AuthGuard],
      },
      {
        path: 'recommendations',
        loadComponent: () => import('./components/recommendation/recommendation.component').then((m) => m.RecommendationComponent),
      },
      {
